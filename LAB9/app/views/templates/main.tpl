	...
	<div id="wrapper">
		...
		<nav id="menu">
			...
			<ul>
				...
				{else}
					<li><a href="{$conf->action_root}UserDataShow">{$user->Imie} {$user->Nazwisko}</a></li>
					{if  $user->role == 'Pracownik'}
						<li><a href="{$conf->action_root}BookAddShow">Dodaj Książkę</a></li>
					{/if}

						{if $user->role == 'Admin'}
							<li><a href="{$conf->action_root}RoleShow">Zmień Role</a></li>
						{/if}
		...
		<footer id="footer">
			<div class="inner">
				<section>
					<h2>Get in touch</h2>
					<form method="post" action="{$conf->action_root}wiadomosci">
						<div class="fields">
				...
				<section>
					<h2>Follow</h2>
					<ul class="icons">
						<li><a href="https://github.com/Twiggiermaen21" class="icon brands style2 fa-github"><span
