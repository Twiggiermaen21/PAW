...
require_once $conf->root_path . '/app/calc.php';
...
class CalcCtrl 
{
	...
	public function validate()
	{
		...
		global $role;
			...
			if ($this->form->kwota>100000 && $role <> 'admin') {
				$this->msgs->addError("Tylko administrator może przydzielić kredyt powyżej 100 000 PLN");
			...
			if ($this->form->oprocentowanie<10 && $role <> "admin") {
				$this->msgs->addError("Tylko administrator może przydzielić kredyt o oprocentrowaniu poniżej 10%.");
			}
